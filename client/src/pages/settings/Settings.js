...
const Settings = () => {
  ...
  return (
    <div className="container mt-4 mb-5">
      <h1>User Settings</h1>
      <p className="text-muted mb-4">Manage your account and application preferences.</p>
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleUpdatePreferences}>
                <div className="mb-3 form-check">
                  ...
                  <div className="form-text">Receive general email notifications about your account.</div>
                </div>
                ...
                <div className="mb-3 form-check">
                  <input
                    ...
                    onChange={handlePreferenceChange}
                  />
                  <label className="form-check-label" htmlFor="scan_completion_alerts">
                    Scan Completion Alerts
                  </label>
                  <div className="form-text">Get notified when your security scans are completed.</div>
                </div>
                ...
                <div className="mb-3 form-check">
                  <input
                    ...
                    onChange={handlePreferenceChange}
                  />
                  <label className="form-check-label" htmlFor="vulnerability_alerts">
                    Critical Vulnerability Alerts
                  </label>
                  <div className="form-text">Receive immediate alerts for critical or high-severity vulnerabilities.</div>
                </div>
                ...
                <div className="mb-3 form-check">
                  ...
                  <div className="form-text">Receive weekly summary reports of all security findings.</div>
                </div>
                ...
                <div className="mb-3 form-check">
                  ...
                  <div className="form-text">Enable dark mode for the application interface.</div>
                </div>
