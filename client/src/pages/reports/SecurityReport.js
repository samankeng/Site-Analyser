        ...
        <div className="d-flex">
          ...
          {reportData.status === "completed" && (
            <button
              ...
              onClick={() =>
                reportService.generatePdf(reportData.id, reportData.is_virtual)
              }
            >
              Download PDF
            </button>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p>
                ...
                {reportData.scan_types?.join(", ") || "Full Scan"}
              </p>
            </div>
            <div className="col-md-6 text-md-end">
              <div className="d-inline-block text-center p-3 border rounded">
                ...
                <div
                  className={`display-4 ${getScoreColorClass(securityScore)}`}
                >
                  {securityScore}
                </div>
        ...
        <div className="card-header">
          <ul className="nav nav-tabs card-header-tabs">
            ...
            <li className="nav-item">
              <button
                className={`nav-link ${
                  activeTab === "ai-recommendations" ? "active" : ""
                }`}
            ...
            <div>
              ...
              {!reportData.results || reportData.results.length === 0 ? (
                <div className="alert alert-info">
                  No vulnerabilities found. Your site passed all security
                  checks!
                </div>
              ) : (
